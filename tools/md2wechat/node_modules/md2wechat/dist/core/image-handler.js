...
export class ImageHandler {
     ...
     */
    async uploadToWechat(imagePath, type = 'image') {
        ...
        try {
            ...
            logger.error(`Failed to upload image: ${imagePath} - ${error.message}`);
     ...
     */
    async uploadImages(images, type = 'image') {
        const map = {};
     ...
     */
    async processImages(html, type = 'image') {
